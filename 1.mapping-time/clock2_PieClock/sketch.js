...
function draw() {
  ...
  // measure the current time and re-map the number from time proportion to location proportion
    var now = clock()
    let HourAngle = map(now.hours, 0, 23, 0, 360) // from hours (0-23) to pixels (0-360)
  ...
  // draw the second hands
    fill(175, 175, 175);
    arc(200, 200, 280, 280, radians(270), radians(270+SecAngle));     
  ...
  // draw the hour hand
    fill(55, 55, 55);
    arc(200, 200, 80, 80, radians(270), radians(270+HourAngle));     
